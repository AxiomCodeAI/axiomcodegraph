...
DOCS = {
 ...
 "py_type_inference": "An inferred type for a binding / expression / field / parameter / return. A RELATION rather\n// than columns because a union is 1:N (c8 unionSize == \"1\" is the monomorphic test). c5\n// evidence and c6 confidence record HOW we know. The PARSER emits only purely syntactic\n// evidence (LITERAL, COLLECTION_LITERAL, FSTRING, COMPREHENSION, ANNOTATION, CAST,\n// DEFAULT_VALUE); CONSTRUCTOR_CALL / BUILTIN_CALL / ISINSTANCE_GUARD and everything at\n// POSSIBLE need name or call resolution and are the ENGINE's to append.",
