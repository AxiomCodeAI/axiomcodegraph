...
| 1 | `edgeRole` [J] | 1 | `ROOT` \| `RECEIVER` \| `QUALIFIER` \| `ARGUMENT` \| `METHOD_NAME` \| `PROPERTY_NAME` \| `INDEX_ARGUMENT` \| `LEFT_OPERAND` \| `RIGHT_OPERAND` \| `TERNARY_*` \| `UNARY_OPERAND` \| `AS_OPERAND` \| `SATISFIES_OPERAND` \| `SPREAD_OPERAND` \| `TEMPLATE_SPAN` \| `ARROW_BODY` \| `OBJECT_PROPERTY_KEY` \| `OBJECT_PROPERTY_VALUE` \| `ARRAY_ELEMENT` \| `TAG_EXPRESSION` \| `JSX_ATTRIBUTE_VALUE` \| `JSX_CHILD` |
