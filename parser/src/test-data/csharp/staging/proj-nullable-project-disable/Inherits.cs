// NO #nullable DIRECTIVE. This file inherits `disable` from the .csproj, so
// every unannotated reference type is OBLIVIOUS and every `string?` below is a
// CS8632 warning. The file is byte-identical to its twin apart from these
// comment lines and the namespace.
// Its twin is
// ../proj-nullable-project-enable/Inherits.cs.
using System;
