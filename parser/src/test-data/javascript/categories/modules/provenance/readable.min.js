// fixture: cjs/provenance/readable.min.js
...
// BUNDLED_EXCLUDED is the .min.js suffix, matched by JS_MINIFIED_NAME_PATTERN
...
function minMarker(value) {
  return String(value).toUpperCase();
}

module.exports = { minMarker };
