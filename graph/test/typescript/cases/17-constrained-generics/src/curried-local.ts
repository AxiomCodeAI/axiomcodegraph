// THE SHAPE THAT SLIPPED PAST THE GATE — DECLARED IN THE CLIENT.
// remeda declares its own utilities, so the regression was client->client: the engine
// answered `prop.ts:452 IMPLEMENTATION` where the compiler named the signature at
// `prop.ts:71`, both in remeda's own source. The library copy of this file covers the
// same shape across the boundary; this one covers where it actually bit.
// ORIGINAL NOTE: Sixteen golden cases and five fixtures passed
