...
process.on('exit', () => {
  ...
  require('node:fs').writeFileSync("/Users/swapnilpaliwal/Documents/AxiomCode/wt/js-reshape/graph/test/javascript/torture/.work/edges.json", JSON.stringify(out, null, 1));
});
